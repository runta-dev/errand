import { ArrowUp, CircleStop, Cloud, Command, FileText, Globe2, LoaderCircle, Terminal } from "lucide-react";
...
export function Conversation({ agent, messages, activities, connection, onSend, onReconnect, onToggleDetails, onOpenPalette }: { agent: Agent; messages: Message[]; activities: ActivityEvent[]; connection: ConnectionState; onSend(text: string): Promise<void>; onReconnect(): void; onToggleDetails(): void; onOpenPalette(): void }) {
